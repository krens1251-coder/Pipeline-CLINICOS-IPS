...
- Cálculo automático de días sin contacto, alerta de contacto, días en etapa, alerta de etapa y flag.
- KPIs y cobertura calculados automáticamente a partir del pipeline visible; los negocios cerrados dejan de sumar cobertura.
- Creación y edición de negocios desde la web con botón `+ Nuevo negocio` y `Editar negocio`.
- Nuevo campo `Estado del negocio` con opciones de cierre y observación.
